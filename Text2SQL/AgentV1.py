...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_AgentV1.ipynb.

# %% auto 0
__all__ = ['MD', 'create_system_prompt', 'md_user', 'str2key_value', 'md_tool', 'md_assistant']

# %% ../nbs/01_AgentV1.ipynb 2
...
# %% ../nbs/01_AgentV1.ipynb 3
from IPython.display import Markdown, display
MD = lambda x: display(Markdown(x))

# %% ../nbs/01_AgentV1.ipynb 5
...
"""
    ...
    if not success:
        return base_str + f"❌ **Error:** {content.get('error')}"
    ...
    return base_str + f"""✅ **Result** ({row_count} rows, {exec_time:.2f}s)

{table}
"""

# %% ../nbs/01_AgentV1.ipynb 29
...
"""
        ...
        reasoning_section = f"\n\n💭 _Reasoning: {reasoning}_" if reasoning else ""
